 ...
 */
/**
 * Namespace app.modules.test Class UserTest.java
 *
 * @date 11/1/13
...
//        user.insert();
//        user.addNoID(mbr);// nambah ke parent karena member punya user_id <== parent
//
//        Member mmbr = Member.findById(mbr.getId());
//
//        User userParent = mmbr.parent(User.class);
//        a(mmbr.parent(User.class)).shouldNotBeNull();
//        a(userParent).shouldNotBeNull();
//        a(userParent.get("name")).shouldBeEqual("nanang suryadi");
