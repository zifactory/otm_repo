 ...
 */
/**
 * Namespace app.controllers.setting Class CategoryController.java
 *
 * @date 12/3/13
...
public class CategoryController extends AppController {
    ...
    /* ===============================================================================
     ...
     ==================================================================================*/
    /**
     * //GET : /3/cats display a list of all category return void
     */
    public void index() {
        HashMap<String, Object> grid = new HashMap<>();
        //set fields sesuai urutan colnames
        ArrayList<Object> acats = new ArrayList<>();
        acats.removeAll(acats);
...
//        render("/layouts/gridview");
    ...
    /**
     * //GET : /3/cats/add/ return an HTML form for creating a new category
     * return void
     */
    @GET
    public void a001() {
    ...
    /**
     * {POST} : /3/cats create a new category .save return void
     */
    @POST
    public void s003() {
        if (isPost()) {
            ...
            if (params().containsKey("save") && !param("keterangan").equalsIgnoreCase("")) {
                ...
                if (!ZHelper.shouldBeNull(param("root")) && !param("root").isEmpty()) {
    ...
    /**
     * {GET} : /3/cats/{ID} View Form Detail return void
     */
    public void v005() {
        try {
            HashMap<String, Object> formulir = new HashMap<>();
    ...
    /**
     * {PUT} : /3/cats/{ID} update a specific category return void
     */
    @PUT
    public void u009() {
    ...
    /**
     * Ajax with msgBox {DELETE} : /3/cats/{ID} delete a specific category
     * return void
     */
    @DELETE
    public void d011() {
    ...
    public void dtbl() {
        ...
        String sWhere = "";
        ArrayList<Object> sParams = new ArrayList<>();
        ...
        /*
         * Data aaData ArrayList
         * */
        ArrayList<Object> aaData = new ArrayList<>();
        for (Category cat : rResult) {
            ArrayList<Object> ct = new ArrayList<>();
            ct.removeAll(ct);
            for (String sColumn : aColumns) {
                ct.add(cat.get(sColumn));
            }
