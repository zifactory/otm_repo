        ...
        <div class="card">
            <form action="${(formulir.action)!"#"}" method="${(formulir.method)!"POST"}" style="width:350px;">
                <div class="form-group">
                    <label for="kabname">Kabupaten Name</label>
                    <input type="text" class="form-control" name="keterangan" id="kabname"
                           placeholder="Enter Kabupaten Name" value="${(formulir.fkt.keterangan)!""}">
                </div>
