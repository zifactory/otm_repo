        ...
        <div class="card-list">
            <div class="card">
                <div class="login-content">
                    <form action="${context_path}/3/l/signup" method="POST">
                        <div class="login-form" style="position:relative;float: left;">
                            ...
                            <div class="control-group">
                                <div class="checkbox left">
                                    <div class="checker"><span><input type="checkbox" name="rememberme"
                                                                      value="true"></span>
                                    </div>
                                    Remember Me
                                    <label class="label">
                                        <a href="#"><i class="fa fa-check"></i> forget password?</a>
                                    </label>
                                </div>
                            </div>
                            <div class="control-group">
                        ...
                        <div class="signup-form"
                            ...
                            <blockquote>
                                <div class="control-group">
                                    <div class="input-icon left">
                                        <i class="fa fa-user"></i><input type="text" class="m-wrap" name="name"
                                                                         placeholder="Firstname Lastname"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="input-icon left">
                                        <i class="fa fa-envelope"></i><input type="text" class="m-wrap" name="email"
                                                                             placeholder="Email"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="input-icon left">
                                        <i class="fa fa-lock"></i><input type="password" class="m-wrap"
                                                                         name="passwordup"
                                                                         placeholder="Password"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="input-icon left">
                                        <i class="fa fa-warning"></i><input type="password" class="m-wrap"
                                                                            name="confirmpass"
                                ...
                                <div class="control-group">
                                    <div class="input-icon left">
                                        <i class="fa fa-share"></i><input type="submit" class="m-wrap btn orange"
